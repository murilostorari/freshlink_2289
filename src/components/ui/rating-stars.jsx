...
export const StarIcon = ({ progress = 100, ...props }) => {
    const id = useId();

    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...props} className={cx("size-4 text-warning-400", props.className)}>
            <path
...
export const RatingStars = ({ rating = 5, stars = 5, starClassName, ...props }) => {
    return (
