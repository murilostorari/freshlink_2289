  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="flex items-center space-x-2 px-3 py-2 bg-muted rounded-lg text-sm font-body font-medium text-foreground hover:bg-muted/80 transition-colors duration-200"
      >
